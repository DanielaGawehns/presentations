...
% Poll
\center 
Are you wearing an activity tracker atm?
...
Persona I : Mark
\center
\includegraphics[width=50mm]{img/mark}
...
Persona II : Janine
\center
\includegraphics[width=50mm]{img/janine}
...
Persona III : Karla 
\center
\includegraphics[width=50mm]{img/karla}
...
\center
%Three Icons 
\includegraphics[width=30mm]{img/mark}\includegraphics[width=30mm]{img/janine}\includegraphics[width=30mm]{img/karla}
...
\begin {itemize}
    \item tracking of activity, heart rate, location, interactions, Ecological Momentary Assessment 
...
\includegraphics[width=85mm]{img/OverviewUsecases}
...
\begin {itemize}
\item Apple Watch % for population studies - large trends 
	\begin {itemize}
	\item Apple Research App
	\item Health Kit and Care Kit Frameworks
	\item built your own
	\end {itemize}
\pause
\item Fitbit
...
\begin {itemize}
\item granularity (temporal and compounds)
\pause
\item web API 's 
\pause
\item possibly certification issues
\end {itemize}
...
% aim of datenspende: die Ausbreitung der Infektionen einschätzen zu können - i.e. no individual prediction of how you are doing, but general trends; they use postal code for approximation of where people are - more or less 
...
\begin {frame}{The How - Privacy}
\begin {itemize}
\item Which path does the data take?
\item Privacy statement between participant and producer, or between researcher and producer?
\end {itemize}
\end {frame}
%%%%%%%%%%%%%%
...
Open science is the practice of science in such a way that others can \textbf{collaborate} and \textbf{contribute}, where research data, lab notes and other research processes are freely available, \textbf {under terms} that enable reuse, \textbf{redistribution} and \textbf{reproduction} of the research and its underlying data and \textbf{methods}.

{\fontsize{5}{6}\selectfont https://www.fosteropenscience.eu/foster-taxonomy/open-science-definition} 
...
\item \textbf{collaborate} and \textbf{contribute}
	...
	\end {itemize}
	\pause
\item \textbf {under terms} that enable reuse
	\pause
...
\pause
Preprint regarding HR: Nelson et al. (2020): Guidelines for Wrist-Worn Consumer Wearables: Assessment of Heart Rate in Biobehavioral Research; https://psyarxiv.com/3wk65
...
%Danish study
%Sandra Servia-Rodríguez et al. 2017. Mobile sensing at the service of mental well-being: a large-scale longitudinal study. In WWW ?17. 103?112.
...
\item bulk download of health data possible 
...
\begin {itemize}
\item locked in to a handful (android) devices 
\item limited lifestyle apps
...
\includegraphics[width=40mm]{img/stakeholders}\includegraphics[width=70mm]{img/mission}
...
\begin {frame}{A Mission}


An independent community of researchers and other stakeholders evoking cultural shift towards sustainable research.\\
The community works towards a common toolkit, which is transparent, flexible to use and open for improvements and changes. \\
Sustainable research is better privacy, adaptable design, affordable, transparent. \\
Transparency allows everyone in the community to take their own decisions and draw their own conclusions about the product. 
...
%% Poll
Is a truly open Activity Tracker an option? \\
% Yes, No
\end {frame}
...
%% Poll
Which solution has most potential? \\
A: Homebrew, Samsung \\
B: Android App \\
C: Astroid OS  \\
D: other (leave answer in chat)
% ABCD
\end {frame}

\begin {frame}{What do you think? }
%% Poll
Is is worth to explore the astroidOS + custom smartwatch route? \\
% Yes, No
\end {frame}

\begin {frame}{What do you think? }
%% Poll
Do you know of other people working on opening activity trackers for research?
% Yes, No
...
Contact: \\
Daniela Gawehns \\
gawehnsd@liacs.leidenuniv.nl \\
Twitter: @dgawehns \\

Some people behind the Mission Statement and Platform Work: \\
Assia Kraan (Hogeschool van Amsterdam, Digital Society School) \\
Daphne Tona (CURIUM, Leiden)\\
...
\item Case Studies:
	\begin {itemize}
	\item Focus on Emotion Lab at Leiden Uni: https://www.focusonemotions.nl
	\item Exodus Project: https://digitalsocietyschool.org/project/intention-mirror/
	\item Dementia Project: https://www.universiteitleiden.nl/en/research/research-projects/data-science-research-programme/data-science-research-programme-project-daniela-gawehns
	\end {itemize}
...
\item Consumer Grade Wearables
	\begin {itemize}
	\item Apple: https://github.com/researchkit/researchkit 
	\item fitbit: https://healthsolutions.fitbit.com/researchers/ \\ https://healthsolutions.fitbit.com/researchers/faqs/ 
	\item garmin:
	\item fitabase (for fitbit and garmin): https://www.fitabase.com/how-it-works/faq/ \\ https://www.fitabase.com/resources/knowledge-base/learn-about-fitbit-data/data-resolutions/
	\item https://www.elektralabs.com/solutions/evaluation
	\end {itemize}
\end {itemize}
...
\item Using big Tech
	\begin {itemize}
	\item Meyer N., et al (2018): Capturing Rest-Activity Profiles in Schizophrenia Using Wearable and Mobile Technologies: Development, Implementation, Feasibility, and Acceptability of a Remote Monitoring Platform 
	\item corona-dataspende.de
	\item Stanford Health Study: https://innovations.stanford.edu/wearables
	\end {itemize}
...
\item Suggested Solutions
	\begin {itemize}
	\item https://github.com/abumondol/WaDa
	\item https://github.com/DanielaGawehns/SamsungDataCollection
	\item https://asteroidos.org + homebrew
	\end {itemize}
...
\item Pipelines to analyze data
	\begin {itemize}
	\item https://dbdp.org
	\item https://github.com/wadpac/GGIR
	\item many, many more!
	\end {itemize}
